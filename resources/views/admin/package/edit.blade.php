...
@section('title', 'Edit Package – Di-tool Admin')
...
@section('content')
    <header class="flex items-center justify-between mb-8">
        <div>
            ...
            <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Edit Package</h2>
            <p class="text-slate-500 text-sm">{{ $package->name }}</p>
        </div>
    </header>
