...
@section('title', 'Add Issue Type – Di-tool Admin')
...
@section('content')
    <header class="flex items-center justify-between mb-8">
        <div>
            ...
            <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Add Issue Type</h2>
            <p class="text-slate-500 text-sm">Add a category or subcategory for the Help Center sidebar tree.</p>
        </div>
    </header>
